...
class LogStash::Inputs::Kafka < LogStash::Inputs::Base
  ...
  # The identifier of the group instance this consumer belongs to. Consumer group instance must be
  # a unique identifier. It reduces number of rebalances and need kafka brokers 2.3+.
